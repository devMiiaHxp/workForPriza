        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
                PrizaX is your strategic ally in cultivating practical excellence for the digital era. Our
mission is to empower individuals and workforces with a dynamic blend of online and on-site training, delivering hands-on skills that elevate efficiency and drive positive
change in the ever-evolving digital landscape.
          ...
          <div>
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto" src={check} width="1024" height="504" alt="Hero" />
              <a
