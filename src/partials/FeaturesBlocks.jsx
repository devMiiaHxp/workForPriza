      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Why PrizaX?</h2>
            <p className="text-xl text-gray-400">
              &nbsp;
              <li>
                Our courses seamlessly integrate online and on-site training
                offering a flexible approach to meet the unique needs of
                security-focused professionals.
              </li>
              &nbsp;
              <li>
                Our seasoned instructors are devoted to imparting skills that
                lead to tangible outcomes, enhancing both professional and
                personal efficiency.
              </li>
              &nbsp;
              <li>
                PrizaX's diverse courses not only elevate workforce capabilities
                but also empower citizens, contributing to a digitally skilled
          ...
          >
            ...
            >
              ...
              <svg
                className="w-16 h-16 mb-4 bg-purple-600 rounded-full p-3"
                viewBox="0 0 24 24"
              ...
              >
                ...
                strokeLinecap="round" strokeWidth="1" fill="none" fillRule="evenodd"
                />
              </svg>
              {/* <svg
                className="w-16 h-16 mb-4 bg-purple-600 rounded-full p-2"
                id="Layer_1"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                data-name="Layer 1"
